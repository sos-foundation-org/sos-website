        ...
        <main>
          ...
          <section className="relative w-full min-h-[100svh] md:min-h-[100vh] flex items-center justify-center overflow-hidden">
            <Image
              ...
              alt="Mountain landscape representing SOS research field sites"
              fill
            ...
            >
              <div className="flex items-start gap-4 flex-1">
                <div className="h-10 w-10 rounded-2xl overflow-hidden shrink-0">
                  <Image src="/logo/SOS-LOGO_v3-icon.svg" alt="SOS Foundation Logo" width={40} height={40} className="h-full w-full object-cover" unoptimized />
                </div>
