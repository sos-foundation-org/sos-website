  ...
  return (
    <div className="relative h-16 w-16 md:h-20 md:w-20">
      ...
      <div className="absolute inset-0 overflow-hidden rounded-[28px] isolate">
        <NextImage
          src="/logo/SOS-LOGO_v2-for_SVG.svg"
          alt="SOS Foundation logo — Sustainability of Sustainability"
          fill
        ...
        <section id="hero" className="relative w-full min-h-screen pt-14 md:pt-20 flex items-center justify-center overflow-hidden">
            ...
            >
              <div className="flex flex-col items-center">
                <NextImage
                  src="/logo/SOS-LOGO_v2-for_SVG.svg"
                  alt="SOS Foundation infinity loop logo"
                  width={192}
                  height={88}
    ...
    <section id="involved" className="mx-auto max-w-6xl px-5 pb-24">
      ...
      <div className="mt-10 grid md:grid-cols-5 gap-5">
        <RoleCard
          ...
          bgAlt="Artists collaborating in a studio space"
        />
        <RoleCard
          ...
          bgAlt="Museum specimen collection and research workspace"
        />
        <RoleCard
          ...
          bgAlt="Entrepreneurs discussing sustainable system prototypes"
        />
        <RoleCard
          ...
          bgAlt="Partners and funders at a sustainability collaboration event"
        />
        <RoleCard
          ...
          bgAlt="Educators engaging students in sustainability learning"
        />
      </div>
  ...
  return (
    ...
    >
      <div className="relative h-full">
        {bgImage ? (
            <div className="absolute inset-0">
            <NextImage src={bgImage} alt={bgAlt} fill className="object-cover" sizes="(max-width: 768px) 100vw, 20vw" />
            <div
